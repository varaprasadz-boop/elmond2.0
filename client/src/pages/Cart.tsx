...
{isAuthenticated ? (
          /* Logged-in user layout: Cart items (left) + Order summary (right) */
          ...
          /* Guest user layout: Billing details (left) + Cart items + Order summary (right) */
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  {/* Coupon Input - now available for guest users */}
                  {!appliedCoupon && (
                    <div className="mb-6">
                      <Label htmlFor="coupon" className="mb-2 block">Enter Coupon Code</Label>
                      <div className="flex gap-2">
